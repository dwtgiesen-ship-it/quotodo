    ...
    <div className="grid min-h-full place-items-center bg-[#fafbfc] px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-[#eef0f2] bg-white p-7 shadow-sm">
          <h1 className="font-heading text-[22px] font-semibold tracking-tight text-[#1f2a4d]">{t.signupTitle}</h1>
          <p className="mt-1 text-[14px] text-[#5b6472]">{t.signupSubtitle}</p>
          ...
          <div className="mt-3 flex items-center gap-1.5 text-[12px] text-[#9097a3]"><Check className="size-3.5 text-[#4F9A57]" /> {t.noCard}</div>
        </div>
        <p className="mt-4 text-center text-[14px] text-[#5b6472]">{t.haveAccount} <Link href="/salonflow/login" className="font-semibold text-[#1f2a4d] hover:underline">{t.loginCta}</Link></p>
      </div>
    </div>
  );
}
